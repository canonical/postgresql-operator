...
async def test_canonical_livepatch_onprem_bundle_db(ops_test: OpsTest, charm: str) -> None:
    ...
    # We intentionally wait for the `✘ sync_token not set` as we aren't providing
    # an Ubuntu Pro token (as this is just a test to ensure the database works
    # in the context of the relation with the Livepatch charm).
    overlay = {
