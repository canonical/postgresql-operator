...
def test_update_certificate(self, _, _request_certificate):
    ...
    harness.charm.get_secret("unit", "ca") == ca
    harness.charm.get_secret("unit", "cert") == cert
    harness.charm.get_secret("unit", "key") == key
    harness.charm.get_secret("unit", "private-key") == private_key
