...
class PostgresqlOperatorCharm(TypedCharmBase[CharmConfig]):
    ...
    def set_secret(self, scope: Scopes, key: str, value: str | None) -> str | None:
        ...
        (self.scoped_peer_data(scope) or {}).pop(key, None)
    ...
    def postgresql(self) -> PostgreSQL:
        ...
        # TODO: Port none handling in the lib
        return PostgreSQL(
            primary_host=self.primary_endpoint,  # type: ignore
    ...
    def _on_peer_relation_departed(self, event: RelationDepartedEvent) -> None:
        ...
        try:
            ...
            logger.warning(
                f"Early exit on_peer_relation_departed: Cannot get {event.departing_unit} member IP"
            )
            return
    ...
    def _add_members(self, event):
        ...
        try:
            ...
            if (
                self._patroni.cluster_members == self._hosts
