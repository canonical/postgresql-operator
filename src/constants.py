...
SNAP_STORAGE_PATH = f"{SNAP_COMMON_PATH}/data"
...
POSTGRESQL_STORAGE_SUBPATH = "16/main"
POSTGRESQL_ARCHIVE_MOUNT_PATH = f"{SNAP_STORAGE_PATH}/archive"
POSTGRESQL_DATA_MOUNT_PATH = f"{SNAP_DATA_PATH}/postgresql"
POSTGRESQL_LOGS_MOUNT_PATH = f"{SNAP_STORAGE_PATH}/logs"
POSTGRESQL_TEMP_MOUNT_PATH = f"{SNAP_STORAGE_PATH}/temp"
POSTGRESQL_ARCHIVE_PATH = f"{POSTGRESQL_ARCHIVE_MOUNT_PATH}/{POSTGRESQL_STORAGE_SUBPATH}"
POSTGRESQL_DATA_PATH = f"{POSTGRESQL_DATA_MOUNT_PATH}/{POSTGRESQL_STORAGE_SUBPATH}"
POSTGRESQL_LOGS_STORAGE_PATH = f"{POSTGRESQL_LOGS_MOUNT_PATH}/{POSTGRESQL_STORAGE_SUBPATH}"
POSTGRESQL_WAL_PATH = f"{POSTGRESQL_LOGS_STORAGE_PATH}/pg_wal"
POSTGRESQL_TEMP_PATH = f"{POSTGRESQL_TEMP_MOUNT_PATH}/{POSTGRESQL_STORAGE_SUBPATH}/pgsql_tmp"
