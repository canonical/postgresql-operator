...
[Integrations](https://documentation.ubuntu.com/juju/3.6/reference/relation/), also known as "relations", are the easiest way to create a user for PostgreSQL in Charmed PostgreSQL VM. 
