...
* [Legacy PostgreSQL charm](/explanation/legacy-charm) in track "[latest](https://charmhub.io/postgresql?channel=14/stable)" does **not** support the Juju storage abstraction.
